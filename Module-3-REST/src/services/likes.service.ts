...
export class LikesService {
    ...
    static async findLikes(idComment: number): Promise<Like[]>{
    ...
    static async update(idComment:number,id:number, input:CreateLikeDto):Promise<Like>{
    ...
    static async deleteLike(idLike:number){
    ...
    static async updateLikePost(idPost:number,id:number, input:CreateLikeDto):Promise<Like>{
        const updateLike = await prisma.like.upsert({ 
            where: {
            id: id,
            },
